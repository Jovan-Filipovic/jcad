...
from classes.commandbar import CommandBar
from classes.statusbar import StatusBar
from classes.toolbar import ToolbarCanvas, DraggableToolbar
from classes.toolbarapp import ToolbarApp
...
class MainApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("jcad v9.0tk version")
